    ...
    for hidden_dim in HIDDEN_DIM:
        for n_layers in N_LAYERS:
            for grid_size in GRID_SIZE:
                ...
                model = FASTKAGIN(args.n_gnn_layers, dataset.num_features, hidden_dim, n_layers, grid_size, 12, args.dropout).to(device)
                ...
                for epoch in range(1, args.epochs+1):
                    ...
                    if val_error < best_val_error:
                        ...
                        best_hyperparams = {'lr': lr, 'hidden_dim': hidden_dim, 'n_layers': n_layers, 'grid_size': grid_size}
...
for run in range(10):
    ...
    model = FASTKAGIN(args.n_gnn_layers, dataset.num_features, best_hyperparams['hidden_dim'], best_hyperparams['n_layers'], best_hyperparams['grid_size'], 12, args.dropout).to(device)
