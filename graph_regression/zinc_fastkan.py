    ...
    for hidden_dim in HIDDEN_DIM:
        for n_layers in N_LAYERS:
            for grid_size in GRID_SIZE:
                ...
                model = FASTKAGIN(args.n_gnn_layers, 21, hidden_dim, n_layers, grid_size, 1, args.dropout, True).to(device)
...
for run in range(10):
    ...
    model = FASTKAGIN(args.n_gnn_layers, 21, best_hyperparams['hidden_dim'], best_hyperparams['n_layers'], best_hyperparams['grid_size'], 1, args.dropout, True).to(device)
