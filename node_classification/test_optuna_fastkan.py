...
def main():
    ...
    for dataset_name in [ 'Cora', 'CiteSeer', 'Wisconsin','Cornell','Texas', 'Actor', 'ogbn-arxiv']: 
        for conv_type in ['gcn','gin']:                     
            ...
            test_mean, test_sd, time_  = train_and_evaluate_model(hidden_channels, lr, hidden_layers, regularizer, data, dataset_name, dataset, conv_type, skip, grid_size,  n_epochs, device )
