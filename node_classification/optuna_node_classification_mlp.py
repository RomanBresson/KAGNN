...
def objective(trial: Trial,
    ...
    hidden_channels = trial.suggest_int('hidden_channels', 8, 1024)
...
def train_and_evaluate_model(hidden_channels: int,
    ...
    if dataset_name == 'ogbn-arxiv':
        ...
        model = GNN_Nodes(conv_type=conv_type, mp_layers=mp_layers, num_features=dataset.num_features,
                hidden_channels=hidden_channels, num_classes=dataset.num_classes, skip=skip, hidden_layers=hidden_layers, dropout=dropout).to(device)
